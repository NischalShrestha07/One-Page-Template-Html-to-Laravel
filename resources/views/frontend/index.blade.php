		...
		<div class="row">
			<div class="col-md-12 text-center">
				<div class="header-text">
					...
					<a href="{{ asset('frontend/download/browney.txt') }}" download>download resume</a>
				</div>
				<!--/.header-text-->
			</div>
			<!--/.col-->
			...
			<div class="row">
				<div class="col-sm-6">
					<div class="single-about-txt">
						<h3>
							I am a Professional UI/UX Designer and Web developer. Consectetur an adipisi elita, sed do
						...
						<p>
							...
							mollit anim id est laborum. Sed ut perspi unde omnis iste natus error sit voluptatem
							accusantium doloremque lauda ntium, totam rem aperiam, eaque ipsa quae ab illo inventore
							veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam vo luptatem
				...
				<div class="col-sm-offset-1 col-sm-5">
					<div class="single-about-img">
						<img src="{{ asset('frontend/images/about/profile_image.jpg') }}  " alt="profile_image">
			...
			<div class="portfolio-content">
				<div class="isotope">
					<div class="row">
						...
						<div class="col-sm-4">
							<div class="item">
								<img src="{{ asset('frontend/images/portfolio/p1.jpg' ) }}" alt='portfolio image' />
							...
							<div class="item">
								<img src="{{ asset('frontend/images/portfolio/p2.jpg') }}" alt="portfolio image" />
								<div class="isotope-overlay">
									<a href="#">
										ui/ux design
									</a>
						...
						<div class="col-sm-4">
							<div class="item">
								<img src="{{ asset('frontend/images/portfolio/p3.jpg') }}" alt="portfolio image" />
								<div class="isotope-overlay">
									<a href="#">
										web design
									</a>
						...
						<div class="col-sm-4">
							<div class="item">
								<img src="{{ asset('frontend/images/portfolio/p4.jpg') }}" alt="portfolio image" />
								<div class="isotope-overlay">
									<a href="#">
										web development
									</a>
							...
							<div class="item">
								<img src="{{ asset('frontend/images/portfolio/p5.jpg') }}" alt="portfolio image" />
								<div class="isotope-overlay">
									<a href="#">
										web development
									</a>
	...
	<div class="clients-area">
		<div class="container">
			<div class="owl-carousel owl-theme" id="client">
				<div class="item">
					<a href="#">
						<img src="{{ asset('frontend/images/clients/c1.png') }}" alt="brand-image" />
					</a>
				</div>
				<!--/.item-->
				<div class="item">
					<a href="#">
						<img src="{{ asset('frontend/images/clients/c2.png') }}" alt="brand-image" />
					</a>
				</div>
				<!--/.item-->
				<div class="item">
					<a href="#">
						<img src="{{ asset('frontend/images/clients/c3.png') }}" alt="brand-image" />
					</a>
				</div>
				<!--/.item-->
				<div class="item">
					<a href="#">
						<img src="{{ asset('frontend/images/clients/c4.png') }}" alt="brand-image" />
					</a>
				</div>
				<!--/.item-->
				<div class="item">
					<a href="#">
						<img src="{{ asset('frontend/images/clients/c5.png') }}" alt="brand-image" />
					</a>
				</div>
				<!--/.item-->
				<div class="item">
					<a href="#">
						<img src="{{ asset('frontend/images/clients/c6.png') }}" alt="brand-image" />
					</a>
				</div>
				<!--/.item-->
				<div class="item">
					<a href="#">
						<img src="{{ asset('frontend/images/clients/c7.png') }}" alt="brand-image" />
					</a>
				</div>
				<!--/.item-->
			</div>
